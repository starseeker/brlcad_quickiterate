...
| `bv_scene_visible_nodes()` — collect all visible nodes (complements `bv_scene_selected_nodes`) | Phase 3 | ✅ COMPLETE |
| `bv_scene_set_all_visible()` — batch set visibility on all nodes (returns change count) | Phase 3 | ✅ COMPLETE |
