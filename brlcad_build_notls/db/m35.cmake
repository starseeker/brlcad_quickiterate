...
set(BU_DIR_CACHE ${CBDIR}/cache_m35)
set(LIBRT_CACHE ${CBDIR}/rtcache_m35)
...
# run the conversion.
execute_process(
  COMMAND "${CONV_EXEC}" "/home/runner/work/brlcad_quickiterate/brlcad_quickiterate/brlcad/db/m35.asc" "/home/runner/work/brlcad_quickiterate/brlcad_quickiterate/brlcad_build_notls/share/db/m35.g"
...
if(conv_result)
  set(CARGS "/home/runner/work/brlcad_quickiterate/brlcad_quickiterate/brlcad/db/m35.asc" "/home/runner/work/brlcad_quickiterate/brlcad_quickiterate/brlcad_build_notls/share/db/m35.g")
  message(FATAL_ERROR "[m35] Failure: ${conv_result}\n${CONV_EXEC} ${CARGS}\"\n\n${conv_log}")
endif(conv_result)
