...
set(BU_DIR_CACHE ${CBDIR}/cache_tank_car)
set(LIBRT_CACHE ${CBDIR}/rtcache_tank_car)
...
# run the conversion.
execute_process(
  COMMAND "${CONV_EXEC}" "/home/runner/work/brlcad_quickiterate/brlcad_quickiterate/brlcad/db/tank_car.asc" "/home/runner/work/brlcad_quickiterate/brlcad_quickiterate/brlcad_build_notls/share/db/tank_car.g"
...
if(conv_result)
  set(CARGS "/home/runner/work/brlcad_quickiterate/brlcad_quickiterate/brlcad/db/tank_car.asc" "/home/runner/work/brlcad_quickiterate/brlcad_quickiterate/brlcad_build_notls/share/db/tank_car.g")
  message(FATAL_ERROR "[tank_car] Failure: ${conv_result}\n${CONV_EXEC} ${CARGS}\"\n\n${conv_log}")
endif(conv_result)
