...
set(BU_DIR_CACHE ${CBDIR}/cache_havoc)
set(LIBRT_CACHE ${CBDIR}/rtcache_havoc)
...
# run the conversion.
execute_process(
  COMMAND "${CONV_EXEC}" "/home/runner/work/brlcad_quickiterate/brlcad_quickiterate/brlcad/db/havoc.asc" "/home/runner/work/brlcad_quickiterate/brlcad_quickiterate/brlcad_build_notls/share/db/havoc.g"
...
if(conv_result)
  set(CARGS "/home/runner/work/brlcad_quickiterate/brlcad_quickiterate/brlcad/db/havoc.asc" "/home/runner/work/brlcad_quickiterate/brlcad_quickiterate/brlcad_build_notls/share/db/havoc.g")
  message(FATAL_ERROR "[havoc] Failure: ${conv_result}\n${CONV_EXEC} ${CARGS}\"\n\n${conv_log}")
endif(conv_result)
