...
set(BU_DIR_CACHE ${CBDIR}/cache_die)
set(LIBRT_CACHE ${CBDIR}/rtcache_die)
...
# run the conversion.
execute_process(
  COMMAND "${CONV_EXEC}" "/home/runner/work/brlcad_quickiterate/brlcad_quickiterate/brlcad/db/die.asc" "/home/runner/work/brlcad_quickiterate/brlcad_quickiterate/brlcad_build_notls/share/db/die.g"
...
if(conv_result)
  set(CARGS "/home/runner/work/brlcad_quickiterate/brlcad_quickiterate/brlcad/db/die.asc" "/home/runner/work/brlcad_quickiterate/brlcad_quickiterate/brlcad_build_notls/share/db/die.g")
  message(FATAL_ERROR "[die] Failure: ${conv_result}\n${CONV_EXEC} ${CARGS}\"\n\n${conv_log}")
endif(conv_result)
