...
set(ofiles  "/home/runner/work/brlcad_quickiterate/brlcad_quickiterate/brlcad_build_notls/regress/gcv/obj/conv-tetra.g" "/home/runner/work/brlcad_quickiterate/brlcad_quickiterate/brlcad_build_notls/regress/gcv/obj/conv-tetra-assetimport.g")
foreach(of ${ofiles})
  file(REMOVE "${of}")
...
set(log_msg "Running:
  COMMAND \"${GCV_EXEC}\" \"${in_path}\" \"/home/runner/work/brlcad_quickiterate/brlcad_quickiterate/brlcad_build_notls/regress/gcv/obj/conv-tetra.g\" 
  COMMAND \"${GCV_EXEC}\" \"--input-format=assetimport\" \"--output-format=brlcad\" \"${in_path}\" \"/home/runner/work/brlcad_quickiterate/brlcad_quickiterate/brlcad_build_notls/regress/gcv/obj/conv-tetra-assetimport.g\"\n\n")
file(APPEND "${LOGFILE}" "${log_msg}")

execute_process(
  COMMAND "${GCV_EXEC}" "${in_path}" "/home/runner/work/brlcad_quickiterate/brlcad_quickiterate/brlcad_build_notls/regress/gcv/obj/conv-tetra.g" COMMAND "${GCV_EXEC}" "--input-format=assetimport" "--output-format=brlcad" "${in_path}" "/home/runner/work/brlcad_quickiterate/brlcad_quickiterate/brlcad_build_notls/regress/gcv/obj/conv-tetra-assetimport.g"
