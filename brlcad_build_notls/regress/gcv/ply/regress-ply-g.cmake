...
set(CSDIR "/home/runner/work/brlcad_quickiterate/brlcad_quickiterate/brlcad/regress/gcv/ply")
set(CBDIR "/home/runner/work/brlcad_quickiterate/brlcad_quickiterate/brlcad_build_notls/regress/gcv/ply")
set(LOGFILE "${CBDIR}/regress-ply-g.log")

file(WRITE "${LOGFILE}" "Starting ply testing\n\n")
...
if(EXISTS "${CSDIR}/tetra.ply")
  set(in_path "${CSDIR}/tetra.ply")
elseif(EXISTS "${CBDIR}/tetra.ply")
  set(in_path "${CBDIR}/tetra.ply")
elseif(FALSE AND EXISTS "${CSDIR}/../tetra.ply")
  # if this is an exporter, check regress/gcv for .g files used to test multiple converters
  set(in_path "${CSDIR}/../tetra.ply")
else()
  message(FATAL_ERROR "[gcv] could not find tetra.ply, searched ${CSDIR} and ${CBDIR}. aborting.")
endif(EXISTS "${CSDIR}/tetra.ply")

# blow away expected output file if it exists for some reason
set(ofiles  "/home/runner/work/brlcad_quickiterate/brlcad_quickiterate/brlcad_build_notls/regress/gcv/ply/conv-tetra.g" "/home/runner/work/brlcad_quickiterate/brlcad_quickiterate/brlcad_build_notls/regress/gcv/ply/conv-tetra-assetimport.g")
foreach(of ${ofiles})
  file(REMOVE "${of}")
endforeach(of ${ofiles})

# Run the converter for tetra.ply
set(log_msg "Running:
  COMMAND \"${GCV_EXEC}\" \"${in_path}\" \"/home/runner/work/brlcad_quickiterate/brlcad_quickiterate/brlcad_build_notls/regress/gcv/ply/conv-tetra.g\" 
  COMMAND \"${GCV_EXEC}\" \"--input-format=assetimport\" \"--output-format=brlcad\" \"${in_path}\" \"/home/runner/work/brlcad_quickiterate/brlcad_quickiterate/brlcad_build_notls/regress/gcv/ply/conv-tetra-assetimport.g\"\n\n")
file(APPEND "${LOGFILE}" "${log_msg}")

execute_process(
  COMMAND "${GCV_EXEC}" "${in_path}" "/home/runner/work/brlcad_quickiterate/brlcad_quickiterate/brlcad_build_notls/regress/gcv/ply/conv-tetra.g" COMMAND "${GCV_EXEC}" "--input-format=assetimport" "--output-format=brlcad" "${in_path}" "/home/runner/work/brlcad_quickiterate/brlcad_quickiterate/brlcad_build_notls/regress/gcv/ply/conv-tetra-assetimport.g"
