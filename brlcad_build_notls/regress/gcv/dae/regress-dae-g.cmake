...
set(CSDIR "/home/runner/work/brlcad_quickiterate/brlcad_quickiterate/brlcad/regress/gcv/dae")
set(CBDIR "/home/runner/work/brlcad_quickiterate/brlcad_quickiterate/brlcad_build_notls/regress/gcv/dae")
set(LOGFILE "${CBDIR}/regress-dae-g.log")

file(WRITE "${LOGFILE}" "Starting dae testing\n\n")
...
if(EXISTS "${CSDIR}/tetra.dae")
  set(in_path "${CSDIR}/tetra.dae")
elseif(EXISTS "${CBDIR}/tetra.dae")
  set(in_path "${CBDIR}/tetra.dae")
elseif(FALSE AND EXISTS "${CSDIR}/../tetra.dae")
  # if this is an exporter, check regress/gcv for .g files used to test multiple converters
  set(in_path "${CSDIR}/../tetra.dae")
else()
  message(FATAL_ERROR "[gcv] could not find tetra.dae, searched ${CSDIR} and ${CBDIR}. aborting.")
endif(EXISTS "${CSDIR}/tetra.dae")

# blow away expected output file if it exists for some reason
set(ofiles  "/home/runner/work/brlcad_quickiterate/brlcad_quickiterate/brlcad_build_notls/regress/gcv/dae/conv-tetra.g")
foreach(of ${ofiles})
  file(REMOVE "${of}")
endforeach(of ${ofiles})

# Run the converter for tetra.dae
set(log_msg "Running:
  COMMAND \"${GCV_EXEC}\" \"--input-format=assetimport\" \"${in_path}\" \"/home/runner/work/brlcad_quickiterate/brlcad_quickiterate/brlcad_build_notls/regress/gcv/dae/conv-tetra.g\"\n\n")
