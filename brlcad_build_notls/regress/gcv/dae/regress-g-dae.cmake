...
set(LOGFILE "${CBDIR}/regress-g-dae.log")
...
set(ofiles  "/home/runner/work/brlcad_quickiterate/brlcad_quickiterate/brlcad_build_notls/regress/gcv/dae/conv-tetra.dae")
foreach(of ${ofiles})
  file(REMOVE "${of}")
...
set(log_msg "Running:
  COMMAND \"${GCV_EXEC}\" \"--output-format=assetimport\" \"${in_path}\" \"/home/runner/work/brlcad_quickiterate/brlcad_quickiterate/brlcad_build_notls/regress/gcv/dae/conv-tetra.dae\"\n\n")
...
foreach(out_file ${ofiles})
  if(NOT EXISTS "${out_file}")
    ...
    if("${file_size}" GREATER "4117")
      math(EXPR size_delta "${file_size} - 4117")
    else("${file_size}" GREATER "4117")
      math(EXPR size_delta "4117 - ${file_size}")
    endif("${file_size}" GREATER "4117")

    if("${size_delta}" GREATER "350")
      file(APPEND "${LOGFILE}" "FAILURE: ${curr_result} file size is ${file_size} for ${out_file}\n    Expecting 4117 with delta 350")
