...
set(CSDIR "/home/runner/work/brlcad_quickiterate/brlcad_quickiterate/brlcad/regress/gcv/3ds")
set(CBDIR "/home/runner/work/brlcad_quickiterate/brlcad_quickiterate/brlcad_build_notls/regress/gcv/3ds")
set(LOGFILE "${CBDIR}/regress-3ds-g.log")

file(WRITE "${LOGFILE}" "Starting 3ds testing\n\n")
...
if(EXISTS "${CSDIR}/tetra.3ds")
  set(in_path "${CSDIR}/tetra.3ds")
elseif(EXISTS "${CBDIR}/tetra.3ds")
  set(in_path "${CBDIR}/tetra.3ds")
elseif(FALSE AND EXISTS "${CSDIR}/../tetra.3ds")
  # if this is an exporter, check regress/gcv for .g files used to test multiple converters
  set(in_path "${CSDIR}/../tetra.3ds")
else()
  message(FATAL_ERROR "[gcv] could not find tetra.3ds, searched ${CSDIR} and ${CBDIR}. aborting.")
endif(EXISTS "${CSDIR}/tetra.3ds")

# blow away expected output file if it exists for some reason
set(ofiles  "/home/runner/work/brlcad_quickiterate/brlcad_quickiterate/brlcad_build_notls/regress/gcv/3ds/conv-tetra.g")
foreach(of ${ofiles})
  file(REMOVE "${of}")
endforeach(of ${ofiles})

# Run the converter for tetra.3ds
set(log_msg "Running:
  COMMAND \"${GCV_EXEC}\" \"--input-format=assetimport\" \"${in_path}\" \"/home/runner/work/brlcad_quickiterate/brlcad_quickiterate/brlcad_build_notls/regress/gcv/3ds/conv-tetra.g\"\n\n")
