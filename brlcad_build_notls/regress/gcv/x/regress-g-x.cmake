...
set(CSDIR "/home/runner/work/brlcad_quickiterate/brlcad_quickiterate/brlcad/regress/gcv/x")
set(CBDIR "/home/runner/work/brlcad_quickiterate/brlcad_quickiterate/brlcad_build_notls/regress/gcv/x")
set(LOGFILE "${CBDIR}/regress-g-x.log")
...
set(ofiles  "/home/runner/work/brlcad_quickiterate/brlcad_quickiterate/brlcad_build_notls/regress/gcv/x/conv-tetra.x")
foreach(of ${ofiles})
  file(REMOVE "${of}")
...
set(log_msg "Running:
  COMMAND \"${GCV_EXEC}\" \"--output-format=assetimport\" \"${in_path}\" \"/home/runner/work/brlcad_quickiterate/brlcad_quickiterate/brlcad_build_notls/regress/gcv/x/conv-tetra.x\"\n\n")
...
foreach(out_file ${ofiles})
  if(NOT EXISTS "${out_file}")
    ...
    if("${file_size}" GREATER "3526")
      math(EXPR size_delta "${file_size} - 3526")
    else("${file_size}" GREATER "3526")
      math(EXPR size_delta "3526 - ${file_size}")
    endif("${file_size}" GREATER "3526")

    if("${size_delta}" GREATER "350")
      file(APPEND "${LOGFILE}" "FAILURE: ${curr_result} file size is ${file_size} for ${out_file}\n    Expecting 3526 with delta 350")
