...
set(CSDIR "/home/runner/work/brlcad_quickiterate/brlcad_quickiterate/brlcad/regress/gcv/off")
set(CBDIR "/home/runner/work/brlcad_quickiterate/brlcad_quickiterate/brlcad_build_notls/regress/gcv/off")
set(LOGFILE "${CBDIR}/regress-off-g.log")

file(WRITE "${LOGFILE}" "Starting off testing\n\n")
...
if(EXISTS "${CSDIR}/tetra.off")
  set(in_path "${CSDIR}/tetra.off")
elseif(EXISTS "${CBDIR}/tetra.off")
  set(in_path "${CBDIR}/tetra.off")
elseif(FALSE AND EXISTS "${CSDIR}/../tetra.off")
  # if this is an exporter, check regress/gcv for .g files used to test multiple converters
  set(in_path "${CSDIR}/../tetra.off")
else()
  message(FATAL_ERROR "[gcv] could not find tetra.off, searched ${CSDIR} and ${CBDIR}. aborting.")
endif(EXISTS "${CSDIR}/tetra.off")

# blow away expected output file if it exists for some reason
set(ofiles  "/home/runner/work/brlcad_quickiterate/brlcad_quickiterate/brlcad_build_notls/regress/gcv/off/conv-tetra.g")
foreach(of ${ofiles})
  file(REMOVE "${of}")
endforeach(of ${ofiles})

# Run the converter for tetra.off
set(log_msg "Running:
  COMMAND \"${GCV_EXEC}\" \"--input-format=assetimport\" \"${in_path}\" \"/home/runner/work/brlcad_quickiterate/brlcad_quickiterate/brlcad_build_notls/regress/gcv/off/conv-tetra.g\"\n\n")
