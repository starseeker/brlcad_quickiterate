...
set(LOGFILE "${CBDIR}/regress-g-glb.log")

file(WRITE "${LOGFILE}" "Starting glb testing\n\n")
...
set(ofiles  "/home/runner/work/brlcad_quickiterate/brlcad_quickiterate/brlcad_build_notls/regress/gcv/gltf/conv-tetra.glb")
foreach(of ${ofiles})
  file(REMOVE "${of}")
...
set(log_msg "Running:
  COMMAND \"${GCV_EXEC}\" \"--output-format=assetimport\" \"${in_path}\" \"/home/runner/work/brlcad_quickiterate/brlcad_quickiterate/brlcad_build_notls/regress/gcv/gltf/conv-tetra.glb\"\n\n")
...
foreach(out_file ${ofiles})
  if(NOT EXISTS "${out_file}")
    ...
    if("${file_size}" GREATER "1476")
      math(EXPR size_delta "${file_size} - 1476")
    else("${file_size}" GREATER "1476")
      math(EXPR size_delta "1476 - ${file_size}")
    endif("${file_size}" GREATER "1476")

    if("${size_delta}" GREATER "350")
      file(APPEND "${LOGFILE}" "FAILURE: ${curr_result} file size is ${file_size} for ${out_file}\n    Expecting 1476 with delta 350")
