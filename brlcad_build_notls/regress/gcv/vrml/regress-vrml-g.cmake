...
set(CSDIR "/home/runner/work/brlcad_quickiterate/brlcad_quickiterate/brlcad/regress/gcv/vrml")
set(CBDIR "/home/runner/work/brlcad_quickiterate/brlcad_quickiterate/brlcad_build_notls/regress/gcv/vrml")
set(LOGFILE "${CBDIR}/regress-vrml-g.log")

file(WRITE "${LOGFILE}" "Starting vrml testing\n\n")
...
if(EXISTS "${CSDIR}/vrml_example.wrl")
  set(in_path "${CSDIR}/vrml_example.wrl")
elseif(EXISTS "${CBDIR}/vrml_example.wrl")
  set(in_path "${CBDIR}/vrml_example.wrl")
elseif(FALSE AND EXISTS "${CSDIR}/../vrml_example.wrl")
  # if this is an exporter, check regress/gcv for .g files used to test multiple converters
  set(in_path "${CSDIR}/../vrml_example.wrl")
else()
  message(FATAL_ERROR "[gcv] could not find vrml_example.wrl, searched ${CSDIR} and ${CBDIR}. aborting.")
endif(EXISTS "${CSDIR}/vrml_example.wrl")

# blow away expected output file if it exists for some reason
set(ofiles  "/home/runner/work/brlcad_quickiterate/brlcad_quickiterate/brlcad_build_notls/regress/gcv/vrml/conv-vrml_example.g")
foreach(of ${ofiles})
  file(REMOVE "${of}")
endforeach(of ${ofiles})

# Run the converter for vrml_example.wrl
set(log_msg "Running:
  COMMAND \"${GCV_EXEC}\" \"${in_path}\" \"/home/runner/work/brlcad_quickiterate/brlcad_quickiterate/brlcad_build_notls/regress/gcv/vrml/conv-vrml_example.g\"\n\n")
