...
set(CSDIR "/home/runner/work/brlcad_quickiterate/brlcad_quickiterate/brlcad/regress/gcv/3mf")
set(CBDIR "/home/runner/work/brlcad_quickiterate/brlcad_quickiterate/brlcad_build_notls/regress/gcv/3mf")
set(LOGFILE "${CBDIR}/regress-g-3mf.log")
...
set(ofiles  "/home/runner/work/brlcad_quickiterate/brlcad_quickiterate/brlcad_build_notls/regress/gcv/3mf/conv-tetra.3mf")
foreach(of ${ofiles})
  file(REMOVE "${of}")
...
set(log_msg "Running:
  COMMAND \"${GCV_EXEC}\" \"--output-format=assetimport\" \"${in_path}\" \"/home/runner/work/brlcad_quickiterate/brlcad_quickiterate/brlcad_build_notls/regress/gcv/3mf/conv-tetra.3mf\"\n\n")
...
foreach(out_file ${ofiles})
  if(NOT EXISTS "${out_file}")
    ...
    if("${file_size}" GREATER "1052")
      math(EXPR size_delta "${file_size} - 1052")
    else("${file_size}" GREATER "1052")
      math(EXPR size_delta "1052 - ${file_size}")
    endif("${file_size}" GREATER "1052")

    if("${size_delta}" GREATER "350")
      file(APPEND "${LOGFILE}" "FAILURE: ${curr_result} file size is ${file_size} for ${out_file}\n    Expecting 1052 with delta 350")
