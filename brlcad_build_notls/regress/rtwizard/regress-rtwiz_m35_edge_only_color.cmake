...
set(CBDIR "/home/runner/work/brlcad_quickiterate/brlcad_quickiterate/brlcad_build_notls/regress/rtwizard")
set(INPUTFILE "share/db/m35.g")
set(CTRLIMG "/home/runner/work/brlcad_quickiterate/brlcad_quickiterate/brlcad/regress/rtwizard/m35_edge_only_color_ref.pix")
set(TGTIMG "/home/runner/work/brlcad_quickiterate/brlcad_quickiterate/brlcad_build_notls/regress/rtwizard/m35_edge_only_color.pix")
set(BIN_DIR "bin")
set(LOGFILE "/home/runner/work/brlcad_quickiterate/brlcad_quickiterate/brlcad_build_notls/regress/rtwizard/m35_edge_only_color.log")
...
execute_process(
  COMMAND "/usr/local/bin/cmake" -E remove -f "${TGTIMG}"
)

# Start with the file using standard UNIX line endings
file(APPEND "${LOGFILE}" "Generating ${TGTIMG}:\n")
execute_process(
  COMMAND "${RTWIZ}" --no-gui -i "${SRCFILE}" -o "${TGTIMG}" -l component --benchmark -z 2 --line-color 100/200/255 -C 30/30/30
