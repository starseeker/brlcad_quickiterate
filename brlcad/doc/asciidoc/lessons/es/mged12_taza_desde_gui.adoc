...
|image:../../lessons/es/images/mged12_mug_handle_frontview.png[] |image:../../lessons/es/images/mged12_mug_handle_topview.png[] 
|Taza y asa desde una vista frontal |Taza y asa desde una vista superior 
|===
