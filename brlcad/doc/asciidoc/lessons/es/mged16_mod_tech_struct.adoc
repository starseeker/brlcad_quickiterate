...
Dele a la placa un color verde semi-brillante. La forma más sencilla de hacer esto es a través del editor de combinaciones, pero esta vez hemos de enfocarnos en la línea de comandos. Tipee: *mater board.r "plastic sh=4" 0 198 0 1[Enter]* Este comando le dice a _MGED_ que: [cols="5*"]
[%noheader]
|===
|mater
|board.r
