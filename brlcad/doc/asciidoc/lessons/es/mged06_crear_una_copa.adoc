...
En esta lección podrás crear una copa similar a la del siguiente ejemplo: image::../../lessons/es/images/mged06_rtgoblet.png[]
...
Seleccione del menú Edit (Editar) y clickea en Escala. Situa el puntero del mouse en la mitad más baja de la Ventana de Gráficos y clickea el botón central del mouse hasta que tu esfera tenga aproximadamente un cuarto del diámetro de la base, como es mostrado en la ilustración siguiente. image::../../lessons/es/images/mged06_goblet1stsphere.png[]
...
Repita estos pasos para mover ball3.s a su posición. Cuando haya terminado, su copa se parecerá a la siguiente desde una vista frontal: image::../../lessons/es/images/mged06_gobletstem.png[]
...
|comb |globet1.c |u |basin1.r |u |stem1.r |u |base1.r 
|Haga una combinación |La nombre globet1.c |uniendo |la región basin1.r |y |la región stem1.r |y |la región base1.r 
|===
