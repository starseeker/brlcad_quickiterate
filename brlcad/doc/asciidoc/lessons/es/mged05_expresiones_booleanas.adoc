...
|Cree una región |La nombre part1.r |Una... |La forma nombrada rcc2.s |Substraiga... |La forma nombrada sph2.s 
|===
...
|image:../../lessons/es/images/mged05_raytracedpart1.png[] |image:../../lessons/es/images/mged05_raytracedpart2.png[] 
|Raytrace de part1.r |Raytrace de part2.r 
|===
