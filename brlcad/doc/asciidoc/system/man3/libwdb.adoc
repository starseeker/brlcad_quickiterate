...
mk_arb4, FILE *fp, char *name, point_tpts[]);
...
mk_tor, FILE *fp, char *name, point_tcenter, vect_tn, double r1 ,r2, mk_cone ( fp , name , base , dir , height , rad1 , rad2 ) FILE *fp);
...
mk_rcc, FILE *fp, char *name, point_tbase, vect_theight, fastf_tradius);
...
mk_addmember, char *name, struct wmember *headp, mat_tmat, intop);
...
mk_bsolid, FILE *fp, char *name, intnsurf, doubleres);
