...
[source]
----
pix-fb [-aicz1] [-Fframebuffer] [-m#lines] [-ssquarefilesize] [-wfile_width] [-nfile_height] [-Ssquarescrsize] [-Wscr_width] [-Nscr_height] [-xfile_xoff] [-yfile_yoff] [-Xscr_xoff] [-Yscr_yoff] [-pseconds] [file.pix]
----
