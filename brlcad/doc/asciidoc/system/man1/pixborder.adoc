...
[source]
----
pixborder [ -b'R G B'] [ -e'R G B'] [ -i'R G B'] [ -t'R G B'] [ -B'H S V'] [ -E'H S V'] [ -I'H S V'] [ -T'H S V'] [-xleft_edge] [-ybottom_edge] [-Xright_edge] [-Ytop_edge] [-a] [-nfile_height] [-ssquaresize] [-wfile_width] [file.pix]
----
