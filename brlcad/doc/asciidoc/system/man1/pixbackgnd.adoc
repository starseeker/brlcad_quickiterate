...
[source]
----
pixbackgnd [-H] [-i] [-ssquaresize] [-wwidth] [-nheight] [-ttitle_height] [-atop_inten] [-bbottom_inten] hue saturation > file.pix
----


[source]
----
pixbackgnd [-H] [-i] [-ssquaresize] [-wwidth] [-nheight] [-ttitle_height] red green blue > file.pix
----
