...
*-S*_noise_scale_::
Scales the noise uniformly in X, Y and Z dimensions by the value _noise_scale._ Values below 1.0 cause the noise pattern to become smaller. Values above 1.0 cause it to get bigger
