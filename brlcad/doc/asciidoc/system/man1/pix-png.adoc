...
*-n file_height*::
tells *pix-png* that the input is _file_height_ scanlines tall


*-w file_width*::
tells *pix-png* that the input is _file_width_ pixels wide
...
*-o PNG_file*::
tells *pix-png* to write image data to the specified _PNG_file_ output file. The *pix-png* command will not write out binary image data directly to a terminal device as a safeguard.
