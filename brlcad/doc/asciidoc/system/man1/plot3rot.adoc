...
performs a 30 degree positive rotation about the Z axis (counter clockwise as viewed from the top), and then translates by 20 units _along this rotated axis._ If the order of these arguments was reversed the effect would not be the same.
...
The final *-g* converts the _gift_ style azimuth and elevations into the conventional UnixPlot (screen) X,Y coordinate system.
