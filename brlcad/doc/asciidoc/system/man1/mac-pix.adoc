...
[source]
----
mac-pix [-clb] [-ssquareMacSize] [-wMac_width] [-nMac_height] [-xMac_xoff] [-yMac_yoff] [-Xoutput_xoff] [-Youtput_yoff] [-SsquareOutputSize] [-Woutput_width] [-Noutput_height] [-Cr/g/b] [file.mac]
----
