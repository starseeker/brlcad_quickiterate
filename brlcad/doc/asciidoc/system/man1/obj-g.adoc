...
[source]
----
obj-g [-c] [-d] [-f] [-ggrouping_option] [-Hplate_thickness] [-i] [-mmode] [-oopen_bot_type] [-p] [-rbot_orientation] [-tdistance_tolerance] [-uunits_str] [-v]... [-xrt_debug_flag] [-XNMG_debug_flag] input.obj output.g
----
