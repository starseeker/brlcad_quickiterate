...
*asc-nmg* converts the specified _ascii_file_ (not a .asc geometry database) to a binary BRL-CAD _nmg.g_ geometry database file containing NMG objects. The _ascii_file_ is expected to contain lines of the following forms:
