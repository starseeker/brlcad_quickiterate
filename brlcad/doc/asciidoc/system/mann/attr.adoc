...
Assigns an attribute name "material_id" to _region_1_. Its value is 10.
...
Assigns an attribute named "comment" to _region_1_. Its value is "This is a comment for region_1."
