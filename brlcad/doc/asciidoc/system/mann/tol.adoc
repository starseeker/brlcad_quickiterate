...
_Calculational tolerances:_ The calculational tolerances are used in evaluating the Boolean operations specified in a combination. This is used, for example, in the *ev, facetize,* and *bev* commands.
