...
== NAME
e - Adds the objects in the argument list to the display list so that they will appear on the MGED display. This is a synonym for the draw command.

== SYNOPSIS

[source]
----
e [-A<attribute name/value pairs>] [-s] [-A -o<attribute name/value pairs>] [-C#/#/#] [<-m1>] {<objects>}
----
...
.Draw specific objects in the MGED display.
[example]
====
