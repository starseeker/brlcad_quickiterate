...
The example shows the use of the *oed* command to place MGED into matrix edit mode. The matrix in the final component of _path_lhs_ that corresponds to the first component of _path_rhs_ will be edited.
