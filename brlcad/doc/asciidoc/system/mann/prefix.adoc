...
Changes the name of all the _objects_ listed by adding the specified _new_ prefix_. All references to the _objects_ will also be changed. The *mvall* command performs a similar function.
