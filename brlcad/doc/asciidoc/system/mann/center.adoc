...
== NAME
center - Positions the center of the mged viewing cube at the specified model coordinates. Without arguments, returns the current center.
...
.Printing the coordinates of the center of the mged display.
[example]
====
mged>*center*
...
.Moving the center of the mged display to a specified point.
[example]
====
