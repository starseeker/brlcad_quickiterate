...
Does the same check as in the first example, but prefixes all the names in _other_model.g_with _abc_ before comparing with the names in the current model.
