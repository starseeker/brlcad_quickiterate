...
*check*::
Performs the requested check on the provided solid. Checks are _degen_faces_, _extra_edges_, _flipped_edges_, _open_edges_, or _solid_. The command will return a 1 (if the specified check finds an issue) or 0.
