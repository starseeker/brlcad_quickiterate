...
Decomposes the _NMG_shape named _shape.nmg_ into maximally connected shells and puts each resulting shell into a separate _NMG_ shape named __part_1, part_2, ....__
