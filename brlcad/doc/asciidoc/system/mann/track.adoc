...
* _x_coordinate of center of rearmost roadwheel.
* _z_coordinate of center of all roadwheels.
* radius of all roadwheels.
* _x_ coordinate of center of drive wheel (rear).
* _z_coordinate of center of drive wheel (rear).
* radius of drive wheel.
* _x_ coordinate of center of idler wheel (front).
* _z_coordinate of center of idler wheel (front).
