...
Adds _obj_name_ to the end of the combination named _comb_name_. The _operation_ may be +, -, or u. If no _operation_ is specified, u is assumed. If _comb_name_ does not exist, it is created.
