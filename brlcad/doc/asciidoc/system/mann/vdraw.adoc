...
* insert -- with arguments of_i c x y z_, the MGED drawing command _#c_ is inserted just before the _ith_position of the command list.
...
+
-- with an argument of _delete list_name_, delete the specified command list.
