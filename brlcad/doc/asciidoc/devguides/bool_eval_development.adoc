...
image::../../devguides/images/evaluation_overview.png[width=3.9in]
...
.Projecting an arbitrary (u, v) point into 3D.
[example]
====
...
When two curves are coincident with one another over a portion of their domains, `m_type` will be `ON_X_EVENT::ccx_overlap`. .Curve-Curve Overlap Intersection
image::../../devguides/images/ccx_overlap_event.png[]

image::../../devguides/images/ccx_overlap_event.png[width=3.9in]
...
image::../../devguides/images/ssx_overlap_event.png[width=3.9in]
...
image::../../devguides/images/ssx_tangent_event.png[width=3.9in]

.Surface-Surface Transverse Intersection
image::../../devguides/images/ssx_transverse_event.png[]

image::../../devguides/images/ssx_transverse_event.png[width=3.9in]
...
image::../../devguides/images/curve_traversal_directions.png[width=3.9in]
...
image::../../devguides/images/compare_endpoint_style.png[width=3.9in]
...
image::../../devguides/images/lcurves_with_shaded_context.png[width=3.9in]
...
image::../../devguides/images/axis_X.png[width=3.9in]
...
image::../../devguides/images/ssx_10_vs_13.png[width=3.9in]
...
image::../../devguides/images/intermediate_linked_curves.png[width=5.9in]
