...
|image:../books/images/tutorial_series_volI_fig02.png[width=2in] |image:../books/images/tutorial_series_volI_fig03.png[width=2in] |image:../books/images/tutorial_series_volI_fig04.png[width=2in] 
|Moss |World |Star 
|image:../books/images/tutorial_series_volI_fig05.png[width=2in] |image:../books/images/tutorial_series_volI_fig06.png[width=2in] |image:../books/images/tutorial_series_volI_fig07.png[width=2in] 
