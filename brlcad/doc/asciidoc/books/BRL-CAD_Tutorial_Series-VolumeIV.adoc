...
* _Triangle_ - A special type of polygon that has exactly three sides.
* _Non-Uniform Rational B-Spline (NURB) Surface_ - A piecewise polynomial representation of a smooth, curved surface (e.g., an airplane wing).
