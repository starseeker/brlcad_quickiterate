...
For more information on the TANKILL file format and import possibilities, contact the Advantage Business Group at the Barbician
 East Street
 Farnham, Surrey
 GU9 7TB

 or visit the web site at http://www.advantage-business.co.uk[http://www.advantage-business.co.uk] (Advantage Business Group, 2003).
