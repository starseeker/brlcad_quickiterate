...
/** @file bsg/plot3.h
 *
 * @brief Plot3 format I/O functions (raster line plot format).
 *
 * Phase 1: thin wrapper around @c bv/plot3.h.  When libbv is removed the
 * plot3 declarations will move here directly.
 */
