 ...
 * information.
 */
/** @addtogroup bsg_faceplate
 *
 * Faceplate / adornment state types.  Canonical home is bsg/faceplate.h;
 * bv/faceplate.h is a backward-compatibility bridge.
 */
/** @{ */
/** @file bsg/faceplate.h */

#ifndef BSG_FACEPLATE_H
#define BSG_FACEPLATE_H
