...
/** @file bsg/vectfont.h
 *
 * @brief Vector font data (hardware-stroke font tables).
 *
 * Phase 1: thin wrapper around @c bv/vectfont.h.  When libbv is removed
 * the vectfont declarations will move here directly.
 */
