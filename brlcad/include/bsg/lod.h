...
bv_mesh_lod_cache(struct bsg_mesh_lod_context *c, const point_t *v, size_t vcnt, const vect_t *vn, int *f, size_t fcnt, unsigned long long user_key, fastf_t fratio);
...
BV_EXPORT void
bv_mesh_lod_destroy(struct bsg_mesh_lod *l);
...
BV_EXPORT void
bv_mesh_lod_detail_setup_clbk(struct bsg_mesh_lod *lod, int (*clbk)(struct bsg_mesh_lod *, void *), void *cb_data);
BV_EXPORT void
bv_mesh_lod_detail_clear_clbk(struct bsg_mesh_lod *lod, int (*clbk)(struct bsg_mesh_lod *, void *));
BV_EXPORT void
bv_mesh_lod_detail_free_clbk(struct bsg_mesh_lod *lod, int (*clbk)(struct bsg_mesh_lod *, void *));
...
typedef struct bsg_mesh_lod_context      bv_mesh_lod_context;
typedef struct bsg_mesh_lod_context_internal bv_mesh_lod_context_internal;
