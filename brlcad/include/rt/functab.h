...
#define RTFUNCTAB_FUNC_PLOT_CAST(_func) ((int (*)(struct bu_list *, struct rt_db_internal *, const struct bg_tess_tol *, const struct bn_tol *, const struct bsg_view *))((void (*)(void))_func))
    ...
    int (*ft_adaptive_plot)(struct bu_list * /*vhead*/,
			    ...
			    const struct bsg_view * /* view info */,
			    fastf_t /* s_size */);
#define RTFUNCTAB_FUNC_ADAPTIVE_PLOT_CAST(_func) ((int (*)(struct bu_list *, struct rt_db_internal *, const struct bn_tol *, const struct bsg_view *, fastf_t))((void (*)(void))_func))
...
#define RTFUNCTAB_FUNC_PERTURB_CAST(_func) ((int (*)(struct rt_db_internal **, const struct rt_db_internal *, int, fastf_t))((void (*)(void))_func))
    ...
    int (*ft_scene_obj)(struct bsg_node * /*s*/,
		   struct directory * /*dp*/,
		   struct db_i * /*dbip*/,
		   const struct bg_tess_tol * /*ttol*/,
		   const struct bn_tol * /*tol*/,
		   const struct bsg_view * /*v*/);
#define RTFUNCTAB_FUNC_SCENE_OBJ_CAST(_func) ((int (*)(struct bsg_node *, struct directory *, struct db_i *, const struct bg_tess_tol *, const struct bn_tol *, const struct bsg_view *))((void (*)(void))_func))
