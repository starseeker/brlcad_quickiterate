...
DM_EXPORT extern int dm_draw_vlist(struct dm *dmp, bsg_vlist *vp);
DM_EXPORT extern int dm_draw_vlist_hidden_line(struct dm *dmp, bsg_vlist *vp);
...
DM_EXPORT extern int dm_draw(struct dm *dmp, bsg_vlist *(*callback)(void *), void **data);
