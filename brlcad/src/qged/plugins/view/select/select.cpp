...
extern "C" {
    const struct qged_tool view_select_tool = { "View Select", view_select_tool_create, 2 };
    const struct qged_tool *view_select_tools[] = { &view_select_tool, nullptr };

    static const struct qged_plugin pinfo = { QGED_VC_TOOL_PLUGIN, QGED_PLUGIN_API_VERSION, view_select_tools, 1 };
