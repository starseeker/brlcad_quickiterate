...
/** @file QBot.h
 *
 * Phase D6 (drawing_modernization): stub bag-of-triangles (BOT) editor that
 * demonstrates the bsg_live_source payload contract for mesh-editing plugins.
 *
 * Workflow
 * --------
 * 1. An overlay node (_bot_edit) is created and a BSG_PL_LIVE payload is
 *    attached via bsg_payload_live_create() when BOT editing begins.
 ...
 * 4. Payload teardown follows bsg_obj_put → bsg_payload_free.
 *
 * Future work
 * -----------
