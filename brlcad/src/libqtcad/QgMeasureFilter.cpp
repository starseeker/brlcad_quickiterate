...
QMeasure2DFilter::get_point()
{
    ...
    point_t vpnt;
    VSET(vpnt, vx, vy, 0);
    struct bsg_camera _mf_cam;
    bsg_view_get_camera(v, &_mf_cam);
    MAT4X3PNT(mpnt, _mf_cam.view2model, vpnt);
    return true;
}
...
QMeasure3DFilter::get_point()
{
    ...
    vect_t dir;
    struct bsg_camera _mf_rcam;
    bsg_view_get_camera(v, &_mf_rcam);
    VMOVEN(dir, _mf_rcam.rotation + 8, 3);
    VUNITIZE(dir);
