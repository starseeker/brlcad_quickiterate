...
struct dm_impl {
    ...
    int (*dm_drawVList)(struct dm *dmp, struct bsg_vlist *vp);
    int (*dm_drawVListHiddenLine)(struct dm *dmp, struct bsg_vlist *vp);
    int (*dm_draw_obj)(struct dm *dmp, bsg_shape *s);
    int (*dm_draw_data_axes)(struct dm *dmp, fastf_t sf, struct bsg_data_axes_state *bndasp);
    int (*dm_draw)(struct dm *dmp, struct bsg_vlist *(*callback_function)(void *), void **data);	/**< @brief formerly dmr_object */
