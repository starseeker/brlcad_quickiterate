...
desc_4(int test_num)
{
	...
	{"v", "verbose",
	    BU_OPT_ARG_OPTIONAL, BU_OPT_VAL_INTEGER, 1, NULL,
	    BU_OPT_OVERRIDE_ARG_TYPE | BU_OPT_OVERRIDE_REPEAT,
	    NULL, NULL, BU_OPT_VAL_UNKNOWN, BU_OPT_OPTION_FLAG_NONE},
	{"o", "output",
	    BU_OPT_ARG_REQUIRED, BU_OPT_VAL_FILE_PATH, 0, NULL,
	    BU_OPT_OVERRIDE_ARG_TYPE,
	    NULL, NULL, BU_OPT_VAL_UNKNOWN, BU_OPT_OPTION_FLAG_NONE},
	{"C", "color",
	    BU_OPT_ARG_REQUIRED, BU_OPT_VAL_COLOR, 0, NULL,
	    BU_OPT_OVERRIDE_ARG_TYPE,
	    NULL, NULL, BU_OPT_VAL_UNKNOWN, BU_OPT_OPTION_FLAG_NONE},
	...
	{"m", "mode",
	    BU_OPT_ARG_REQUIRED, BU_OPT_VAL_KEYWORD, 0, mode_keywords,
