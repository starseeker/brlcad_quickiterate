...
static void
set_absolute_view_tran(bsg_view *v)
{
...
static void
set_absolute_model_tran(bsg_view *v)
{
    point_t new_pos;
    point_t diff;
...
static void
calc_mtran(bsg_view *v, const vect_t tvec)
{
    point_t delta;
    point_t vc, nvc;
...
static void
calc_vtran(bsg_view *v, const vect_t tvec)
{
    vect_t tt;
    point_t delta;
    point_t work;
