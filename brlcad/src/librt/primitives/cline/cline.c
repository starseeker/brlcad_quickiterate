...
int
rt_cline_plot(struct bu_list *vhead, struct rt_db_internal *ip, const struct bg_tess_tol *UNUSED(ttol), const struct bn_tol *UNUSED(tol), const struct bsg_view *UNUSED(info))
{
    struct rt_cline_internal *cline_ip;
    fastf_t top[16*3];
    fastf_t bottom[16*3];
