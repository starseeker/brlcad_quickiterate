...
#define RT_DECLARE_INTERFACE(name) \
    ...
    extern int rt_##name##_plot(struct bu_list *vhead, struct rt_db_internal *ip, const struct bg_tess_tol *ttol, const struct bn_tol *tol, const struct bsg_view *info); \
    extern int rt_##name##_adaptive_plot(struct bu_list *vhead, struct rt_db_internal *ip, const struct bn_tol *tol, const struct bsg_view *v, fastf_t s_size); \
    ...
    extern int rt_##name##_scene_obj(struct bsg_node *vhead, struct directory *dp, struct db_i *dbip, const struct bg_tess_tol *ttol, const struct bn_tol *tol, const struct bsg_view *info) \
...
extern int rt_generic_scene_obj(struct bsg_node *s, struct directory *dp, struct db_i *dbip, const struct bg_tess_tol *ttol, const struct bn_tol *tol, const struct bsg_view *v);
