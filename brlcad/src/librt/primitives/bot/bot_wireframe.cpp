 ...
 **********************************************************/
extern "C" int
rt_bot_adaptive_plot(struct bu_list *vhead, struct rt_db_internal *ip, const struct bn_tol *UNUSED(tol), const struct bsg_view *UNUSED(v), fastf_t UNUSED(s_size))
{
