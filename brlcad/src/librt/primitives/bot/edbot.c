...
static const struct rt_edit_cmd_desc bot_cmds[] = {
    ...
    { ECMD_BOT_MOVEV,       "Move Vertex",         "movement",  3, bot_point_params,  1, 40 },
    { ECMD_BOT_MOVEE,       "Move Edge",           "movement",  3, bot_point_params,  1, 50 },
    { ECMD_BOT_MOVET,       "Move Face",           "movement",  3, bot_point_params,  1, 60 },
    { ECMD_BOT_MOVEV_LIST,  "Move Vertex List",    "movement",  3, bot_delta_params,  1, 70 },
