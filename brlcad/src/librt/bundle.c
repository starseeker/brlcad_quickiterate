 ...
 * the L1 instruction cache for NUBSP bundle shots.
 *
 * Relative to rt_shootray_bundle this function omits:
 *   - struct rt_shootray_status beyond inv_dir (no cut-tree navigation)
 *   - box_start/box_end, lastcut, curcut, lastcell setup
 *   - last_bool_start / incremental boolean evaluation during traversal
 *
