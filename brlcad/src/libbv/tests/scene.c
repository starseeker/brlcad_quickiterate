...
/*
 * This test file intentionally exercises deprecated bv_set_init / bv_set_free
 * and related legacy-view scaffolding as the "old side" for migration-bridge
 * tests (bview_from_old, bview_companion_create, etc.).  Suppress the
 * resulting -Wdeprecated-declarations warnings for this file only.
 */
#ifdef __GNUC__
