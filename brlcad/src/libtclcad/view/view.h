...
extern int to_autoview(struct ged *gedp,
		       ...
		       const char *usage,
		       int maxargs);
extern void to_autoview_view(bsg_view *gdvp, const char *scale);
...
/* Draw */
extern void go_draw(bsg_view *gdvp);
...
extern void to_refresh_view(bsg_view *gdvp);

/* Util */
extern int to_is_viewable(bsg_view *gdvp);
