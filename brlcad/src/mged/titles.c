...
create_text_overlay(struct mged_state *s, struct bu_vls *vp)
{
     ...
     */
    if (MEDIT(s)->edit_flag >= 0 && illump != NULL && bsg_node_u3_get((bsg_node *)illump) != NULL) {
    ...
    if (s->global_editing_state == ST_O_EDIT && illump != NULL && bsg_node_u3_get((bsg_node *)illump) != NULL) {
	struct ged_bv_data *bdata = (struct ged_bv_data *)bsg_node_u3_get((bsg_node *)illump);
...
dotitles(struct mged_state *s, struct bu_vls *overlay_vls)
{
    ...
    if (illump != NULL && bsg_node_u3_get((bsg_node *)illump) != NULL) {
	struct ged_bv_data *bdata = (struct ged_bv_data *)bsg_node_u3_get((bsg_node *)illump);
