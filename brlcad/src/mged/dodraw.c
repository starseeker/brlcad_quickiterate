 ...
 */
static void
mged_bound_solid(struct mged_state *s, struct bsg_node *sp)
{
    point_t bmin, bmax;
    size_t length = 0;
    int cmd;
 ...
 */
void
drawH_part2(struct mged_state *s, int dashflag, struct bu_list *vhead, const struct db_full_path *pathp, struct db_tree_state *tsp, struct bsg_node *existing_sp)
{
    struct bsg_node *sp;
 ...
 */
int
replot_original_solid(struct mged_state *s, struct bsg_node *sp)
{
