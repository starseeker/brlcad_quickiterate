...
set(
  TCL_TCLSH_NAMES
  tclsh
  tclsh${TCL_LIBRARY_VERSION}
  tclsh${TK_LIBRARY_VERSION}
...
if(TCL_ENABLE_TK)
  set(
    TK_WISH_NAMES
    wish
    wish${TCL_LIBRARY_VERSION}
    wish${TK_LIBRARY_VERSION}
...
if(TCLSH_VERSION_STRING)
  ...
  string(REGEX REPLACE "^.*tclsh([0-9]\\.*[0-9]).*$" "\\1" TCL_TCLSH_VERSION "${TCL_TCLSH}")
endif()

set(TCLTK_POSSIBLE_LIB_PATHS "${TCL_INCLUDE_PATH_PARENT}/lib" "${TCL_LIBRARY_PATH}" "${TCL_TCLSH_PATH_PARENT}/lib")
if(TCL_ENABLE_TK)
  set(
    TCLTK_POSSIBLE_LIB_PATHS
    ${TCLTK_POSSIBLE_LIB_PATHS}
...
set(
  TCL_POSSIBLE_LIB_NAMES
  tcl
  tcl${TCL_LIBRARY_VERSION}
  tcl${TCL_TCLSH_VERSION}
  tcl${TK_WISH_VERSION}
  tcl87
  tcl8.7
  tcl87t
...
set(
  TCLSTUB_POSSIBLE_LIB_NAMES
  tclstub
  tclstub${TK_LIBRARY_VERSION}
  tclstub${TCL_TCLSH_VERSION}
...
if(NOT TCL_STUB_LIBRARY)
  find_library(TCL_STUB_LIBRARY NAMES ${TCLSTUB_POSSIBLE_LIB_NAMES} PATHS ${TCLTK_POSSIBLE_LIB_PATHS})
endif()

if(TCL_ENABLE_TK)
  set(
    TK_POSSIBLE_LIB_NAMES
    tk
    tk${TK_LIBRARY_VERSION}
    tk${TCL_TCLSH_VERSION}
    tk${TK_WISH_VERSION}
    tk87
    tk8.7
    tk87t
  ...
  set(
    TK_STUB_POSSIBLE_LIB_NAMES
    tkstub
    tkstub${TCL_LIBRARY_VERSION}
    tkstub${TCL_TCLSH_VERSION}
  ...
  if(NOT TK_STUB_LIBRARY)
    find_library(TK_STUB_LIBRARY NAMES ${TK_STUB_POSSIBLE_LIB_NAMES} PATHS ${TCLTK_POSSIBLE_LIB_PATHS})
  endif()

  set(
    TTK_STUB_POSSIBLE_LIB_NAMES
    ttkstub
    ttkstub${TCL_LIBRARY_VERSION}
    ttkstub${TCL_TCLSH_VERSION}
  ...
  if(NOT TTK_STUB_LIBRARY)
    find_library(TTK_STUB_LIBRARY NAMES ${TTK_STUB_POSSIBLE_LIB_NAMES} PATHS ${TCLTK_POSSIBLE_LIB_PATHS})
  endif()
endif(TCL_ENABLE_TK)
...
foreach(search ${_TCL_SEARCHES})
  find_path(TCL_INCLUDE_PATH NAMES tcl.h ${${search}} PATH_SUFFIXES ${TCLTK_POSSIBLE_INCLUDE_PATH_SUFFIXES})
endforeach()
...
if(TCL_ENABLE_TK)
  foreach(search ${_TCL_SEARCHES})
    find_path(TK_INCLUDE_PATH NAMES tk.h ${${search}} PATH_SUFFIXES ${TCLTK_POSSIBLE_INCLUDE_PATH_SUFFIXES})
  endforeach()
...
if(TCL_ENABLE_TK)
  ...
  find_package_handle_standard_args(TK REQUIRED_VARS TK_LIBRARY TK_STUB_LIBRARY TK_INCLUDE_PATH TK_WISH)
