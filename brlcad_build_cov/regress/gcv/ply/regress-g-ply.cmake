...
set(ofiles  "/home/runner/work/brlcad_quickiterate/brlcad_quickiterate/brlcad_build_cov/regress/gcv/ply/conv-tetra.ply" "/home/runner/work/brlcad_quickiterate/brlcad_quickiterate/brlcad_build_cov/regress/gcv/ply/conv-tetra-assetimport.ply")
foreach(of ${ofiles})
  file(REMOVE "${of}")
...
set(log_msg "Running:
  COMMAND \"${GCV_EXEC}\" \"${in_path}\" \"/home/runner/work/brlcad_quickiterate/brlcad_quickiterate/brlcad_build_cov/regress/gcv/ply/conv-tetra.ply\" 
  COMMAND \"${GCV_EXEC}\" \"--input-format=brlcad\" \"--output-format=assetimport\" \"${in_path}\" \"/home/runner/work/brlcad_quickiterate/brlcad_quickiterate/brlcad_build_cov/regress/gcv/ply/conv-tetra-assetimport.ply\"\n\n")
file(APPEND "${LOGFILE}" "${log_msg}")

execute_process(
  COMMAND "${GCV_EXEC}" "${in_path}" "/home/runner/work/brlcad_quickiterate/brlcad_quickiterate/brlcad_build_cov/regress/gcv/ply/conv-tetra.ply" COMMAND "${GCV_EXEC}" "--input-format=brlcad" "--output-format=assetimport" "${in_path}" "/home/runner/work/brlcad_quickiterate/brlcad_quickiterate/brlcad_build_cov/regress/gcv/ply/conv-tetra-assetimport.ply"
