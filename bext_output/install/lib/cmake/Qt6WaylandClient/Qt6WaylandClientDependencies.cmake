...
set(__qt_WaylandClient_third_party_deps "Wayland\;FALSE\;\;\;;Wayland\;FALSE\;\;\;")
set(__qt_WaylandClient_third_party_package_Wayland_provided_targets "Wayland::Server;Wayland::Client;Wayland::Cursor;Wayland::Egl")

if(__qt_WaylandClient_third_party_deps)
    _qt_internal_find_third_party_dependencies("WaylandClient" __qt_WaylandClient_third_party_deps)
endif()
unset(__qt_WaylandClient_third_party_deps)

# Find Qt tool package.
set(__qt_WaylandClient_tool_deps "Qt6WaylandScannerTools\;6.10.2")
if(__qt_WaylandClient_tool_deps)
    _qt_internal_find_tool_dependencies("WaylandClient" __qt_WaylandClient_tool_deps)
endif()
unset(__qt_WaylandClient_tool_deps)

# note: target_deps example: "Qt6Core\;5.12.0;Qt6Gui\;5.12.0"
set(__qt_WaylandClient_target_deps "Qt6Core\;6.10.2;Qt6Gui\;6.10.2;Qt6WaylandGlobalPrivate\;6.10.2")
set(__qt_WaylandClient_find_dependency_paths "${CMAKE_CURRENT_LIST_DIR}/.." "${_qt_cmake_dir}")
if(__qt_WaylandClient_target_deps)
    _qt_internal_find_qt_dependencies("WaylandClient" __qt_WaylandClient_target_deps
                                      __qt_WaylandClient_find_dependency_paths)
endif()
unset(__qt_WaylandClient_target_deps)
unset(__qt_WaylandClient_find_dependency_paths)
