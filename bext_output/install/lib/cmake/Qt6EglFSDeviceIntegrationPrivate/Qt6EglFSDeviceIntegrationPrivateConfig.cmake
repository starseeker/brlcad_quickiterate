...
set(__qt_EglFSDeviceIntegrationPrivate_always_load_private_module OFF)
include("${CMAKE_CURRENT_LIST_DIR}/Qt6EglFSDeviceIntegrationPrivate-build.cmake" OPTIONAL)
if (Qt6EglFSDeviceIntegrationPrivate_FOUND
        AND NOT Qt6EglFSDeviceIntegrationPrivatePrivate_FOUND
        AND NOT TRUE
        AND (
            __qt_EglFSDeviceIntegrationPrivate_always_load_private_module
    ...
    find_package(Qt6EglFSDeviceIntegrationPrivatePrivate "6.10.2" EXACT
        QUIET
        CONFIG
        PATHS
    ...
    if(NOT Qt6EglFSDeviceIntegrationPrivatePrivate_FOUND)
        get_property(Qt6EglFSDeviceIntegrationPrivatePrivate_warning_shown GLOBAL PROPERTY
            Qt6EglFSDeviceIntegrationPrivatePrivate_warning_shown
        )
        if(NOT Qt6EglFSDeviceIntegrationPrivatePrivate_warning_shown)
            message(VERBOSE
                "The private module package 'Qt6EglFSDeviceIntegrationPrivatePrivate' "
                "could not be found. It possibly needs to be installed separately with your "
                "package manager."
            )
            set_property(GLOBAL PROPERTY
                Qt6EglFSDeviceIntegrationPrivatePrivate_warning_shown ON
            )
        endif()
    endif()
endif()
unset(__qt_EglFSDeviceIntegrationPrivate_always_load_private_module)
...
if (TARGET Qt6::EglFSDeviceIntegrationPrivate)
    ...
    foreach(extra_cmake_include Qt6EglFSDeviceIntegrationPrivateTransitiveExtras.cmake)
