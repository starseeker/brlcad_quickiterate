...
set(__qt_KmsSupportPrivate_always_load_private_module OFF)
include("${CMAKE_CURRENT_LIST_DIR}/Qt6KmsSupportPrivate-build.cmake" OPTIONAL)
if (Qt6KmsSupportPrivate_FOUND
        AND NOT Qt6KmsSupportPrivatePrivate_FOUND
        AND NOT TRUE
        AND (
            __qt_KmsSupportPrivate_always_load_private_module
    ...
    find_package(Qt6KmsSupportPrivatePrivate "6.10.2" EXACT
        QUIET
        CONFIG
        PATHS
    ...
    if(NOT Qt6KmsSupportPrivatePrivate_FOUND)
        get_property(Qt6KmsSupportPrivatePrivate_warning_shown GLOBAL PROPERTY
            Qt6KmsSupportPrivatePrivate_warning_shown
        )
        if(NOT Qt6KmsSupportPrivatePrivate_warning_shown)
            message(VERBOSE
                "The private module package 'Qt6KmsSupportPrivatePrivate' "
                "could not be found. It possibly needs to be installed separately with your "
                "package manager."
            )
            set_property(GLOBAL PROPERTY
                Qt6KmsSupportPrivatePrivate_warning_shown ON
            )
        endif()
    endif()
endif()
unset(__qt_KmsSupportPrivate_always_load_private_module)
...
if (TARGET Qt6::KmsSupportPrivate)
    ...
    foreach(extra_cmake_include Qt6KmsSupportPrivateTransitiveExtras.cmake)
