...
get_target_property(_qt_imported_soname Qt6::Svg IMPORTED_SONAME_RELEASE)
get_target_property(_qt_imported_link_dependencies Qt6::Svg IMPORTED_LINK_DEPENDENT_LIBRARIES_RELEASE)
...
if(_qt_imported_soname)
    set_property(TARGET Qt6::Svg PROPERTY IMPORTED_SONAME_RELWITHDEBINFO "${_qt_imported_soname}")
endif()
if(_qt_imported_link_dependencies)
    set_property(TARGET Qt6::Svg PROPERTY IMPORTED_LINK_DEPENDENT_LIBRARIES_RELWITHDEBINFO "${_qt_imported_link_dependencies}")
endif()
