...
get_target_property(_qt_imported_link_dependencies Qt6::XcbQpaPrivate IMPORTED_LINK_DEPENDENT_LIBRARIES_RELEASE)
...
get_target_property(_qt_imported_link_dependencies_default Qt6::XcbQpaPrivate IMPORTED_LINK_DEPENDENT_LIBRARIES_${QT_DEFAULT_IMPORT_CONFIGURATION})
...
if(_qt_imported_link_dependencies)
    set_property(TARGET Qt6::XcbQpaPrivate PROPERTY IMPORTED_LINK_DEPENDENT_LIBRARIES_RELWITHDEBINFO "${_qt_imported_link_dependencies}")
endif()
...
if(_qt_imported_link_dependencies)
    set_property(TARGET Qt6::XcbQpaPrivate PROPERTY IMPORTED_LINK_DEPENDENT_LIBRARIES_MINSIZEREL "${_qt_imported_link_dependencies}")
endif()
...
if(_qt_imported_link_dependencies_default)
    set_property(TARGET Qt6::XcbQpaPrivate PROPERTY IMPORTED_LINK_DEPENDENT_LIBRARIES "${_qt_imported_link_dependencies_default}")
endif()
